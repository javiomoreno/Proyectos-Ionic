...
var db = null;
angular.module('starter', ['ionic', 'starter.controllers', 'ion-floating-menu', 'ngCordova'])
  ...
  .run(function($ionicPlatform, $cordovaSQLite) {
    $ionicPlatform.ready(function() {
      ...
      $cordovaSQLite.execute(db, "CREATE TABLE IF NOT EXISTS materias (id integer primary key, nombre text, cant_parciales integer, porceUno float, porceDos float, porceTres float, porceCuatro float, notaUno integer, notaDos integer, notaTres integer, notaCuatro integer)");
    });
  })
